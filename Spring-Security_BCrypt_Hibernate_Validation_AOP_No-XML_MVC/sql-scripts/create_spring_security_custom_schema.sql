...
INSERT INTO `spring_security_custom_user`.`users` (username, password, first_name, last_name, email)
VALUES ('john', '$2a$04$eFytJDGtjbThXa80FyOOBuFdK2IwjyWefYkMpiBEFlpBwDH.5PM0K', 'John', 'Doe', 'john@gmail.com'),
...
INSERT INTO `spring_security_custom_user`.`roles` (role)
...
INSERT INTO `spring_security_custom_user`.`users_roles` (user_id, role_id)
VALUES (1, 1),
       (2, 1),
       (2, 2),
       (3, 1),
