...
public class UserDaoImpl implements org.example.springrestdemo.mvc.dao.UserDao {

    @Autowired
    private SessionFactory sessionFactory;

    private Logger logger = Logger.getLogger(org.example.springrestdemo.mvc.dao.UserDaoImpl.class.getSimpleName());
